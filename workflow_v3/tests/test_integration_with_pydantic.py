...
async def test_integration():
    ...
    query_analyzer = QueryAnalyzerAgent(memory)
    query_analyzer.llm_config = llm_config
    schema_linker = SchemaLinkerAgent(memory)
    schema_linker.llm_config = llm_config
    sql_generator = SQLGeneratorAgent(memory)
    sql_generator.llm_config = llm_config
    sql_evaluator = SQLEvaluatorAgent(memory)
    sql_evaluator.llm_config = llm_config
