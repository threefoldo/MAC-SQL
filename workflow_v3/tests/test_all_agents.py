...
class TestAllAgents:
    ...
    def __init__(self):
        ...
        # Initialize agents
        self.query_analyzer = QueryAnalyzerAgent(self.memory)
        self.query_analyzer.llm_config = self.llm_config
        self.schema_linker = SchemaLinkerAgent(self.memory)
        self.schema_linker.llm_config = self.llm_config
        self.sql_generator = SQLGeneratorAgent(self.memory)
        self.sql_generator.llm_config = self.llm_config
        self.sql_evaluator = SQLEvaluatorAgent(self.memory)
        self.sql_evaluator.llm_config = self.llm_config
